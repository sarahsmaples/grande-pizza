module.exports = {
  ...
  name: 'Grande Pizza & Wings',
  restaurantName: 'Grande Pizza & Wings To Go', // Full display name
  cuisine: 'Pizza, Wings & Italian-American',
  ...
  // Contact Information
  address: {
    street: '400 Newark Street',
    city: 'Hoboken',
    state: 'NJ',
    zip: '07030',
  },
  phone: '(201) 459-6070',
  email: 'grandepizzanj@gmail.com',
  domain: 'https://grandepizzawingstogo.com/',
  ...
  id: '873',
  orderUrl: 'https://88restaurants.com/grande-pizza-and-wings-to-go-hoboken-nj/online_orders/new',
  contactFormUrl: 'https://88restaurants.com/grande-pizza-and-wings-to-go-hoboken-nj/contact_forms',

  // Social Media (placeholders for future use)
  socialMedia: {
    facebook: 'https://www.facebook.com/pages/category/Italian-Restaurant/Wings-To-Go-and-Grande-Pizza-199994733356506/',
    twitter: 'https://x.com/Wings2GoHoboken',
    yelp: 'https://www.yelp.com/biz/wings-to-go-hoboken-3',
